...
<nav class="navbar navbar-expand-md navbar-dark bg-info">
	<a class="navbar-brand ml-3" href="<c:url value='/'/>"
		...
		src="<c:url value='/images/home/logo.jpg'/>" id="logotop" width="50px"
		height="50px" class="d-inline-block align-top"> <span
		class="logotitle">야 관 문</span>
	</a>
	<div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
		<ul class="navbar-nav">
			<li class="nav-item active "><a class="nav-link font-do"
				href="<c:url value='/test/start'/>">자가진단</a></li>
			<li class="nav-item active ml-5"><a
				href="<c:url value='/post/list'/>" class="nav-link font-do ml-3">게시판</a>
			</li>
			<li class="nav-item active ml-5"><a
				href="<c:url value='/consult/list'/>" class="nav-link font-do ml-3">상담하기</a>
			</li>
		</ul>
	</div>
